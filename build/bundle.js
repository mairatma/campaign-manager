...
(function () {
  ...
  */
   ...
   */
	...
	this.CM.string = string;
}).call(this);
'use strict';

(function () {
  var core = this.CM.core;
  var array = this.CM.array;
  var async = this.CM.async;
  var Disposable = this.CM.Disposable;
  var object = this.CM.object;
  var string = this.CM.string;
  this.CM.metal = core;
  this.CMNamed.metal = this.CMNamed.metal || {};
  this.CMNamed.metal.core = core;
  this.CMNamed.metal.array = array;
  this.CMNamed.metal.async = async;
  this.CMNamed.metal.Disposable = Disposable;
  this.CMNamed.metal.object = object;
  this.CMNamed.metal.string = string;
}).call(this);
'use strict';

(function () {
	var core = this.CMNamed.metal.core;
	var object = this.CMNamed.metal.object;
	var ActionTypes = this.CM.ActionTypes;
		...
		switch (action.type) {
			...
			case ActionTypes.SAVE_CAMPAIGN:
				...
				if (core.isDefAndNotNull(action.campaign.id)) {
					state[action.campaign.id] = object.mixin(state[action.campaign.id], action.campaign);
				} else {
...
(function () {
	...
	this.CM.editCampaignId = editCampaignId;
}).call(this);
'use strict';
...
(function () {
	...
	this.CM.sourceUrl = sourceUrl;
}).call(this);
'use strict';

(function () {
	var ActionTypes = this.CM.ActionTypes;
	var campaigns = this.CM.campaigns;
	var editCampaignId = this.CM.editCampaignId;
	...
	this.CM.rootReducer = rootReducer;
}).call(this);
'use strict';

(function () {
  var rootReducer = this.CM.rootReducer;
  this.CM.store = Redux.createStore(rootReducer);
}).call(this);
'use strict';

(function () {
	var Disposable = this.CMNamed.metal.Disposable;
  ...
  */
   ...
   */
	...
	this.CM.EventHandle = EventHandle;
}).call(this);
'use strict';

(function () {
	var core = this.CMNamed.metal.core;
	var array = this.CMNamed.metal.array;
	var Disposable = this.CMNamed.metal.Disposable;
	var EventHandle = this.CM.EventHandle;
  ...
  */
   ...
   */
	...
	this.CM.EventEmitter = EventEmitter;
}).call(this);
'use strict';
...
(function () {
  ...
  */
   ...
   */
	...
	this.CM.EventEmitterProxy = EventEmitterProxy;
}).call(this);
'use strict';
...
(function () {
  ...
  */
   ...
   */
	...
	this.CM.EventHandler = EventHandler;
}).call(this);
'use strict';

(function () {
  var EventEmitter = this.CM.EventEmitter;
  var EventEmitterProxy = this.CM.EventEmitterProxy;
  var EventHandle = this.CM.EventHandle;
  var EventHandler = this.CM.EventHandler;
  this.CM.events = EventEmitter;
  this.CMNamed.events = this.CMNamed.events || {};
  this.CMNamed.events.EventEmitter = EventEmitter;
  this.CMNamed.events.EventEmitterProxy = EventEmitterProxy;
  this.CMNamed.events.EventHandle = EventHandle;
  this.CMNamed.events.EventHandler = EventHandler;
}).call(this);
'use strict';

(function () {
	var EventHandle = this.CMNamed.events.EventHandle;
  ...
  */
   ...
   */
	...
	this.CM.DomEventHandle = DomEventHandle;
}).call(this);
'use strict';
...
(function () {
	var core = this.CMNamed.metal.core;
	var object = this.CMNamed.metal.object;
	var DomEventHandle = this.CM.DomEventHandle;
...
(function () {
	var dom = this.CM.dom;
	var EventEmitterProxy = this.CMNamed.events.EventEmitterProxy;
  ...
  */
   ...
   */
	...
	this.CM.DomEventEmitterProxy = DomEventEmitterProxy;
}).call(this);
'use strict';

(function () {
	var dom = this.CM.dom;
	var string = this.CMNamed.metal.string;
  ...
  */
   ...
   */
	...
	this.CM.features = features;
}).call(this);
'use strict';

(function () {
	var async = this.CMNamed.metal.async;
	var dom = this.CM.dom;
...
(function () {
  ...
  */
   ...
   */
	...
	this.CM.globalEvalStyles = globalEvalStyles;
}).call(this);
'use strict';

(function () {
	var dom = this.CM.dom;
	var features = this.CM.features;
...
(function () {
  var dom = this.CM.dom;
  var DomEventEmitterProxy = this.CM.DomEventEmitterProxy;
  var DomEventHandle = this.CM.DomEventHandle;
  var features = this.CM.features;
  var globalEval = this.CM.globalEval;
  var globalEvalStyles = this.CM.globalEvalStyles;
  this.CM.dom = dom;
  this.CMNamed.dom = this.CMNamed.dom || {};
  this.CMNamed.dom.dom = dom;
  this.CMNamed.dom.DomEventEmitterProxy = DomEventEmitterProxy;
  this.CMNamed.dom.DomEventHandle = DomEventHandle;
  this.CMNamed.dom.features = features;
  this.CMNamed.dom.globalEval = globalEval;
  this.CMNamed.dom.globalEvalStyles = globalEvalStyles;
}).call(this);
'use strict';
...
(function () {
  ...
  */
	...
	this.CM.ComponentRegistry = ComponentRegistry;
}).call(this);
'use strict';

(function () {
	var EventEmitter = this.CMNamed.events.EventEmitter;
	var EventHandler = this.CMNamed.events.EventHandler;
  ...
  */
   ...
   */
	...
	this.CM.ComponentRenderer = ComponentRenderer;
}).call(this);
'use strict';
...
(function () {
	...
	var core = this.CMNamed.metal.core;
	var object = this.CMNamed.metal.object;
	var dom = this.CMNamed.dom.dom;
	var DomEventEmitterProxy = this.CMNamed.dom.DomEventEmitterProxy;
	var ComponentRegistry = this.CM.ComponentRegistry;
	var ComponentRenderer = this.CM.ComponentRenderer;
	var EventHandler = this.CMNamed.events.EventHandler;
...
(function () {
  ...
  */
   ...
   */
	...
	this.CM.EventsCollector = EventsCollector;
}).call(this);
'use strict';
...
(function () {
	...
	var ComponentRegistry = this.CM.ComponentRegistry;
	var ComponentRenderer = this.CM.ComponentRenderer;
	var EventsCollector = this.CM.EventsCollector;
	this.CM.component = Component;
	this.CMNamed.component = this.CMNamed.component || {};
	this.CMNamed.component.Component = Component;
	this.CMNamed.component.ComponentRegistry = ComponentRegistry;
	this.CMNamed.component.ComponentRenderer = ComponentRenderer;
	this.CMNamed.component.EventsCollector = EventsCollector;
}).call(this);
'use strict';
...
(function () {
  ...
  */
   ...
   */
	...
	this.CM.IncrementalDomAop = IncrementalDomAop;
}).call(this);
'use strict';
...
(function () {
	...
	var object = this.CMNamed.metal.object;
	var dom = this.CM.dom;
	var ComponentRenderer = this.CMNamed.component.ComponentRenderer;
	var EventsCollector = this.CMNamed.component.EventsCollector;
	var IncrementalDomAop = this.CM.IncrementalDomAop;
  ...
  */
   ...
   */
	...
	this.CM.IncrementalDomRenderer = IncrementalDomRenderer;
}).call(this);
'use strict';
...
(function () {
   ...
   */
	...
	this.CM.HTML2IncDom = HTML2IncDom;
}).call(this);
'use strict';

(function () {
  var HTML2IncDom = this.CM.HTML2IncDom;
  this.CM.withParser = HTML2IncDom;
}).call(this);
'use strict';
...
(function () {
	var core = this.CMNamed.metal.core;
	var object = this.CMNamed.metal.object;
	var ComponentRegistry = this.CMNamed.component.ComponentRegistry;
	var HTML2IncDom = this.CM.withParser;
	var IncrementalDomRenderer = this.CM.IncrementalDomRenderer;
	var SoyAop = this.CM.SoyAop;
   ...
   */
	...
	this.CM.Soy = Soy;
	this.CMNamed.Soy = this.CMNamed.Soy || {};
	this.CMNamed.Soy.Soy = Soy;
	this.CMNamed.Soy.SoyAop = SoyAop;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param171 = function param171() {
        ...
        ie_close('div');
        ie_open('div', null, null, 'class', 'campaign-manager-card-label');
        itext('Active Campaigns');
        ie_close('div');
        ie_close('div');
      };
      $templateAlias2({ children: param171, key: 'card0', cssClass: 'clearfix' }, null, opt_ijData);
      ie_close('div');
      ...
      var param181 = function param181() {
        ...
        ie_close('span');
        ie_open('span', null, null, 'class', 'light-gray');
        itext('$');
        ie_close('span');
        ie_close('div');
        ie_open('div', null, null, 'class', 'campaign-manager-card-label');
      ...
      $templateAlias2({ children: param181, key: 'card1-0', cssClass: 'clearfix' }, null, opt_ijData);
      ie_close('div');
      ...
      var param191 = function param191() {
        ...
        ie_close('div');
        ie_open('p', null, null, 'class', 'campaign-manager-card-label');
        itext('Total leads');
        ie_open('span');
      ...
      $templateAlias2({ children: param191, key: 'card2', cssClass: 'clearfix' }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
  ...
  this.CM.Dashboard = templates;
  this.CMNamed.Dashboard = this.CMNamed.Dashboard || {};
  this.CMNamed.Dashboard.Dashboard = Dashboard;
  this.CMNamed.Dashboard.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      if (opt_data.includeAddCampaignButton) {
        ie_open('h4', null, null, 'class', 'campaign-manager-title campaign-manager-page-title');
  ...
  this.CM.Header = templates;
  this.CMNamed.Header = this.CMNamed.Header || {};
  this.CMNamed.Header.Header = Header;
  this.CMNamed.Header.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('div', null, null, 'class', 'campaign-manager-card ' + (opt_data.cssClass ? opt_data.cssClass : ''));
      ie_open('div', null, null, 'class', 'campaign-manager-card-body clearfix');
      children();
      ie_close('div');
      ie_close('div');
    }
  ...
  this.CM.Card = templates;
  this.CMNamed.Card = this.CMNamed.Card || {};
  this.CMNamed.Card.Card = Card;
  this.CMNamed.Card.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param47 = function param47() {
        ...
        ie_close('div');
        ie_open('div');
        ie_open('img', null, null, 'src', opt_data.imageUrl);
        ie_close('img');
        ie_close('div');
      };
      $templateAlias1({ children: param47 }, null, opt_ijData);
      ie_close('div');
    }
    exports.render = $render;
    if (goog.DEBUG) {
  ...
  this.CM.ImageCard = templates;
  this.CMNamed.ImageCard = this.CMNamed.ImageCard || {};
  this.CMNamed.ImageCard.ImageCard = ImageCard;
  this.CMNamed.ImageCard.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param60 = function param60() {
        ...
        for (var headerIndex69 = 0; headerIndex69 < headerListLen69; headerIndex69++) {
          ...
          ie_open('th', null, null, 'class', 'light-gray ' + (headerIndex69 == 0 ? '' : 'text-center'));
        ...
        for (var rowIndex81 = 0; rowIndex81 < rowListLen81; rowIndex81++) {
          ...
          for (var cellIndex78 = 0; cellIndex78 < cellListLen78; cellIndex78++) {
            ...
            ie_open('td', null, null, 'class', cellIndex78 == 0 ? '' : 'text-center');
  ...
  var TableCard = function (_Component) {
    babelHelpers.inherits(TableCard, _Component);

    function TableCard() {
      babelHelpers.classCallCheck(this, TableCard);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.TableCard = templates;
  this.CMNamed.TableCard = this.CMNamed.TableCard || {};
  this.CMNamed.TableCard.TableCard = TableCard;
  this.CMNamed.TableCard.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';

(function () {
	var templates = this.CM.Dashboard;
	var Component = this.CM.component;
	var Soy = this.CM.Soy;
	...
	var Dashboard = function (_Component) {
		...
		Dashboard.prototype.created = function created() {
		...
		Dashboard.prototype.sum_ = function sum_(name) {
			return this.campaigns.reduce(function (prev, curr) {
				return prev + curr[name];
			}, 0);
		};

		Dashboard.prototype.updateCampaignStatistics_ = function updateCampaignStatistics_() {
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'campaign-manager-edit-campaign');
      ie_open('div', null, null, 'class', 'container-fluid white-bg campaign-manager');
      ie_open('div', null, null, 'class', 'campaign-manager-page-title');
      ...
      ie_close('div');
      ie_close('div');
      ie_open('form', null, null, 'class', 'form-horizontal');
      $templateAlias2(opt_data, null, opt_ijData);
      ie_open('div', null, null, 'class', 'campaign-manager-edit-campaign-journey container-fluid white-bg campaign-manager session');
      ie_open('h2');
      itext('Journey');
      ie_close('h2');
      ie_open('div', null, null, 'class', 'session-description');
      ie_open('p');
      ie_open('b');
      ...
      ie_open('label', null, null, 'for', '', 'class', 'col-md-1 control-label');
      itext('Journey');
      ie_close('label');
      ie_open('div', null, null, 'class', 'col-md-2');
      ie_open('select', null, null, 'class', 'form-control', 'name', 'journey');
      ie_open('option', null, null, 'value', '1');
      itext('Sales Funnel');
      ie_close('option');
      ie_close('select');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-4');
      ie_open('a', null, null, 'class', 'btn-manage-journey');
      ...
      ie_open('div', null, null, 'class', 'container-fluid campaign-manager white-bg session');
      ie_open('div', null, null, 'class', 'form-group');
      ie_open('div', null, null, 'class', 'col-sm-10');
      ie_open('a', null, null, 'href', opt_data.sourceUrl, 'class', 'btn btn-lg btn-success', 'data-onclick', 'save');
      itext((goog.asserts.assert((opt_data.editCampaignId != null ? 'Save' : 'Create') != null), opt_data.editCampaignId != null ? 'Save' : 'Create'));
      itext(' Campaign');
      ie_close('a');
      ie_open('a', null, null, 'href', opt_data.sourceUrl, 'class', 'btn btn-lg btn-lighter');
      itext('Cancel');
      ie_close('a');
      ie_close('div');
      ie_close('div');
  ...
  var EditCampaign = function (_Component) {
    babelHelpers.inherits(EditCampaign, _Component);

    function EditCampaign() {
      babelHelpers.classCallCheck(this, EditCampaign);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.EditCampaign = templates;
  this.CMNamed.EditCampaign = this.CMNamed.EditCampaign || {};
  this.CMNamed.EditCampaign.EditCampaign = EditCampaign;
  this.CMNamed.EditCampaign.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      var $$temp;
      var campaign__soy88 = opt_data.editCampaignId != null ? opt_data.campaigns[opt_data.editCampaignId] : [];
      ...
      ie_close('label');
      ie_open('div', null, null, 'class', 'col-md-4');
      ie_open('input', null, null, 'type', 'text', 'class', 'form-control', 'name', 'name', 'value', ($$temp = campaign__soy88.name) == null ? '' : $$temp);
      ie_close('input');
      ie_close('div');
      ie_open('br', null, null, 'class', 'hidden-md hidden-lg');
      ie_close('br');
      ie_open('label', null, null, 'class', 'col-md-1 col-md-offset-2 control-label');
      itext('Budget:');
      ie_close('label');
      ie_open('div', null, null, 'class', 'col-md-2');
      ie_open('input', null, null, 'type', 'text', 'class', 'form-control', 'name', 'budget', 'value', ($$temp = campaign__soy88.budget) == null ? '' : $$temp);
      ie_close('input');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-2');
      ie_open('select', null, null, 'class', 'form-control');
      ie_open('option');
      itext('($) Dollars');
      ie_close('option');
      ie_close('select');
      ...
      itext((goog.asserts.assert((($$temp = campaign__soy88.description) == null ? '' : $$temp) != null), ($$temp = campaign__soy88.description) == null ? '' : $$temp));
      ie_close('textarea');
      ie_close('div');
      ie_close('div');
      ie_open('div', null, null, 'class', 'form-group');
      $date({ label: 'Starts on:', name: 'startDate', obj: ($$temp = campaign__soy88.startDate) == null ? null : $$temp }, null, opt_ijData);
      ie_open('br', null, null, 'class', 'hidden-md hidden-lg');
      ie_close('br');
      ie_void('div', null, null, 'class', 'col-md-2');
      $date({ label: 'Ends:', name: 'endDate', obj: ($$temp = campaign__soy88.endDate) == null ? null : $$temp }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
    }
    exports.render = $render;
    ...
    function $date(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_close('label');
      ie_open('div', null, null, 'class', 'col-md-2');
      var date__soy110 = opt_data.obj ? opt_data.obj.date : 0;
      var month__soy111 = opt_data.obj ? opt_data.obj.month : 0;
      var dateWithZero__soy112 = date__soy110 < 10 ? '0' + date__soy110 : date__soy110;
      var monthWithZero__soy113 = month__soy111 < 10 ? '0' + month__soy111 : month__soy111;
      ie_open('input', null, null, 'type', 'date', 'class', 'form-control', 'name', name, 'value', opt_data.obj ? opt_data.obj.year + '-' + monthWithZero__soy113 + '-' + dateWithZero__soy112 : '');
      ie_close('input');
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-1');
      ie_open('select', null, null, 'class', 'form-control', 'name', name + 'Time');
      for (var i121 = 0; i121 < 24; i121++) {
        ie_open_start('option');
        iattr('value', i121);
        $selectedOption({ value: opt_data.obj ? opt_data.obj.hours : '', current: i121 }, null, opt_ijData);
        ie_open_end();
        itext((goog.asserts.assert((i121 > 12 ? i121 - 12 : i121) != null), i121 > 12 ? i121 - 12 : i121));
        itext(':00 ');
        itext((goog.asserts.assert((i121 >= 12 ? 'PM' : 'AM') != null), i121 >= 12 ? 'PM' : 'AM'));
        ie_close('option');
      }
      ie_close('select');
      ie_close('div');
  ...
  var EditCampaignDetails = function (_Component) {
    babelHelpers.inherits(EditCampaignDetails, _Component);

    function EditCampaignDetails() {
      babelHelpers.classCallCheck(this, EditCampaignDetails);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.EditCampaignDetails = templates;
  this.CMNamed.EditCampaignDetails = this.CMNamed.EditCampaignDetails || {};
  this.CMNamed.EditCampaignDetails.EditCampaignDetails = EditCampaignDetails;
  this.CMNamed.EditCampaignDetails.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      var campaign__soy140 = opt_data.editCampaignId != null ? opt_data.campaigns[opt_data.editCampaignId] : [];
      ...
      ie_close('div');
      ie_open('div', null, null, 'class', 'col-md-2');
      ie_open('input', null, null, 'type', 'text', 'class', 'form-control', 'name', 'generation.count', 'value', campaign__soy140.goal ? campaign__soy140.goal.generation.count : 0);
      ie_close('input');
      ie_close('div');
      ie_open('label', null, null, 'for', '', 'class', 'col-md-2 control-label');
      ie_open('div', null, null, 'class', 'text-right');
  ...
  var EditCampaignGoal = function (_Component) {
    babelHelpers.inherits(EditCampaignGoal, _Component);

    function EditCampaignGoal() {
      babelHelpers.classCallCheck(this, EditCampaignGoal);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.EditCampaignGoal = templates;
  this.CMNamed.EditCampaignGoal = this.CMNamed.EditCampaignGoal || {};
  this.CMNamed.EditCampaignGoal.EditCampaignGoal = EditCampaignGoal;
  this.CMNamed.EditCampaignGoal.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	...
	var templates = this.CM.EditCampaign;
	var Actions = this.CM.Actions;
	var Component = this.CM.component;
	var Soy = this.CM.Soy;
	...
	var EditCampaign = function (_Component) {
		...
		EditCampaign.prototype.save = function save() {
	...
	this.CM.EditCampaign = EditCampaign;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param276 = function param276() {
        ...
        ie_close('label');
        ie_open('select', null, null, 'class', 'form-control');
        ie_open('option', null, null, 'value', 'name');
        itext('List');
        ie_close('option');
        ie_close('select');
        ie_close('div');
        ie_open('div', null, null, 'class', 'form-inline select');
        ie_open('label');
        itext('Order by:');
        ie_close('label');
        ie_open('select', null, null, 'class', 'form-control', 'data-onchange', opt_data.sort);
        ie_open('option', null, null, 'value', 'name');
        itext('Name');
        ie_close('option');
        ie_open('option', null, null, 'value', 'date');
      ...
      $templateAlias3({ children: param276 }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
    }
    exports.render = $render;
  ...
  var ManageCampaigns = function (_Component) {
    babelHelpers.inherits(ManageCampaigns, _Component);

    function ManageCampaigns() {
      babelHelpers.classCallCheck(this, ManageCampaigns);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.ManageCampaigns = templates;
  this.CMNamed.ManageCampaigns = this.CMNamed.ManageCampaigns || {};
  this.CMNamed.ManageCampaigns.ManageCampaigns = ManageCampaigns;
  this.CMNamed.ManageCampaigns.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'campaign-manager-campaign-table campaign-manager-table');
      ie_open('table', null, null, 'class', 'table table-box');
      ie_open('thead');
      ie_open('tr');
      ie_open('th', null, null, 'class', 'light-gray');
      itext('Name');
      ie_close('th');
      ie_open('th', null, null, 'class', 'light-gray');
      itext('Scheduled Date');
      ...
      for (var campaignIndex315 = 0; campaignIndex315 < campaignListLen315; campaignIndex315++) {
        ...
        ie_open('tr', null, null, 'data-id', campaignData315.id);
        ie_open('td');
        ie_open('span');
        ...
        ie_close('td');
        ie_open('td');
        ie_open('a', null, null, 'href', '/edit-campaign/' + campaignData315.id, 'data-onclick', 'edit_');
  ...
  var CampaignTable = function (_Component) {
    babelHelpers.inherits(CampaignTable, _Component);

    function CampaignTable() {
      babelHelpers.classCallCheck(this, CampaignTable);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.CampaignTable = templates;
  this.CMNamed.CampaignTable = this.CMNamed.CampaignTable || {};
  this.CMNamed.CampaignTable.CampaignTable = CampaignTable;
  this.CMNamed.CampaignTable.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';

(function () {
	var templates = this.CM.ManageCampaigns;
	var Component = this.CM.component;
	var Soy = this.CM.Soy;
	...
	var ManageCampaigns = function (_Component) {
		...
		ManageCampaigns.prototype.created = function created() {
			this.filterAndSortCampaigns_();
			this.on('campaignsChanged', this.filterAndSortCampaigns_);
		};

		ManageCampaigns.prototype.search = function search(data) {
			this.searchValue_ = data.newVal;
			this.filterAndSortCampaigns_();
		};

		ManageCampaigns.prototype.sort = function sort(event) {
			this.sortBy_ = event.target.value;
			this.sortCampaigns_();
		};

		ManageCampaigns.prototype.filterAndSortCampaigns_ = function filterAndSortCampaigns_() {
		...
		ManageCampaigns.prototype.filterCampaigns_ = function filterCampaigns_() {
			...
			this.filteredCampaigns = this.campaigns.filter(function (campaign) {
				return !_this2.searchValue_ || campaign.name.toLowerCase().startsWith(_this2.searchValue_.toLowerCase());
			});
		};

		ManageCampaigns.prototype.sortCampaigns_ = function sortCampaigns_() {
			var _this3 = this;

			this.filteredCampaigns = this.filteredCampaigns.sort(function (c1, c2) {
				if (_this3.sortBy_ === 'date') {
					var start = _this3.toDate_(c1.startDate) - _this3.toDate_(c2.startDate);
					return start !== 0 ? start : _this3.toDate_(c1.endDate) - _this3.toDate_(c2.endDate);
				} else {
	...
	this.CM.ManageCampaigns = ManageCampaigns;
}).call(this);
/*!
...
(function () {
  ...
  this.CMNamed.Promise = this.CMNamed.Promise || {};
  this.CMNamed.Promise.CancellablePromise = CancellablePromise;
  this.CM.Promise = CancellablePromise;
}).call(this);
"use strict";
...
(function () {
	...
	this.CM.parseFromAnchor = parseFromAnchor;
}).call(this);
'use strict';

(function () {
	var core = this.CMNamed.metal.core;
	var parseFromAnchor = this.CM.parseFromAnchor;
...
(function () {
	var core = this.CMNamed.metal.core;
	var string = this.CMNamed.metal.string;
	var parse = this.CM.parse;
	var MultiMap = this.CM.MultiMap;
...
(function () {
   ...
   */
	...
	this.CM.Cacheable = Cacheable;
}).call(this);
'use strict';

(function () {
	var core = this.CMNamed.metal.core;
	var globalEval = this.CMNamed.dom.globalEval;
	var Cacheable = this.CM.Cacheable;
	var CancellablePromise = this.CM.Promise;
...
(function () {
	...
	var EventEmitter = this.CMNamed.events.EventEmitter;
	var EventHandler = this.CMNamed.events.EventHandler;
	var utils = this.CM.utils;
	var globals = this.CM.globals;
	var Route = this.CM.Route;
	var Screen = this.CM.Screen;
	var Surface = this.CM.Surface;
	var Uri = this.CM.Uri;
...
(function () {
	var core = this.CMNamed.metal.core;
	var Uri = this.CM.Uri;
	var Promise = this.CMNamed.Promise.CancellablePromise;
...
(function () {
	var core = this.CMNamed.metal.core;
	var Ajax = this.CM.Ajax;
	var MultiMap = this.CM.MultiMap;
	var CancellablePromise = this.CM.Promise;
	var errors = this.CM.errors;
	var utils = this.CM.utils;
	var globals = this.CM.globals;
	var Screen = this.CM.Screen;
	var Uri = this.CM.Uri;
  ...
  */
	...
	this.CM.RequestScreen = RequestScreen;
}).call(this);
'use strict';
...
(function () {
  ...
  this.CM.Router = templates;
  this.CMNamed.Router = this.CMNamed.Router || {};
  this.CMNamed.Router.Router = Router;
  this.CMNamed.Router.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	...
	var object = this.CMNamed.metal.object;
	var CancellablePromise = this.CM.Promise;
	var Component = this.CMNamed.component.Component;
	var ComponentRegistry = this.CMNamed.component.ComponentRegistry;
	var App = this.CM.App;
	var Route = this.CM.Route;
	var RequestScreen = this.CM.RequestScreen;
	var Soy = this.CM.Soy;
	var templates = this.CM.Router;
  ...
  */
	...
	this.CM.Router = Router;
}).call(this);
'use strict';

(function () {
	var store = this.CM.store;
	var Dashboard = this.CM.Dashboard;
	var EditCampaign = this.CM.EditCampaign;
	var ManageCampaigns = this.CM.ManageCampaigns;
	var Router = this.CM.Router;
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('a', null, null, 'href', opt_data.basePath + opt_data.sourceUrl, 'class', 'back-arrow');
      ie_void('span', null, null, 'class', 'glyphicon glyphicon-menu-left');
      ie_close('a');
    }
    exports.render = $render;
    if (goog.DEBUG) {
  ...
  var BackArrow = function (_Component) {
    babelHelpers.inherits(BackArrow, _Component);

    function BackArrow() {
      babelHelpers.classCallCheck(this, BackArrow);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.BackArrow = templates;
  this.CMNamed.BackArrow = this.CMNamed.BackArrow || {};
  this.CMNamed.BackArrow.BackArrow = BackArrow;
  this.CMNamed.BackArrow.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var tabIndex34 = 0; tabIndex34 < tabListLen34; tabIndex34++) {
        ...
        ie_open('li', null, null, 'class', opt_data.selectedIndex == tabIndex34 ? 'active' : '');
        ie_open('a', null, null, 'href', tabData34.href);
  ...
  this.CM.Tabs = templates;
  this.CMNamed.Tabs = this.CMNamed.Tabs || {};
  this.CMNamed.Tabs.Tabs = Tabs;
  this.CMNamed.Tabs.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'campaign-manager-edit-campaign-tactics container-fluid campaign-manager white-bg session session-merged-next');
      ie_open('h2');
      itext('Tactics');
      ie_close('h2');
      ie_open('div', null, null, 'class', 'session-description');
      ...
      ie_close('div');
      $templateAlias1(opt_data, null, opt_ijData);
      ie_open('input', null, null, 'type', 'hidden', 'value', $join({ ids: opt_data.selectedTacticIds }, null, opt_ijData), 'name', 'tacticIds');
      ie_close('input');
      ie_close('div');
    }
    exports.render = $render;
    ...
    function $join(opt_data, opt_ignored, opt_ijData) {
      ...
      var idList160 = ids;
      var idListLen160 = idList160.length;
      for (var idIndex160 = 0; idIndex160 < idListLen160; idIndex160++) {
        var idData160 = idList160[idIndex160];
        output += idIndex160 > 0 ? ',' : '';
        output += idData160;
      }
      return output;
  ...
  var EditCampaignTactics = function (_Component) {
    babelHelpers.inherits(EditCampaignTactics, _Component);

    function EditCampaignTactics() {
      babelHelpers.classCallCheck(this, EditCampaignTactics);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.EditCampaignTactics = templates;
  this.CMNamed.EditCampaignTactics = this.CMNamed.EditCampaignTactics || {};
  this.CMNamed.EditCampaignTactics.EditCampaignTactics = EditCampaignTactics;
  this.CMNamed.EditCampaignTactics.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	...
	this.CM.CampaignTable = CampaignTable;
}).call(this);
'use strict';
...
(function () {
  ...
  goog.loadModule(function (exports) {
     ...
     */
    function $render(opt_data, opt_ignored, opt_ijData) {
      ie_open('div', null, null, 'class', 'campaign-manager-tactics-table campaign-manager-table');
      ie_open('table', null, null, 'class', 'table table-box');
      ie_open('thead');
      ie_open('tr');
      ie_open('th', null, null, 'class', 'light-gray');
      ...
      ie_close('thead');
      ie_open('tbody');
      var idList334 = opt_data.selectedTacticIds;
      var idListLen334 = idList334.length;
      for (var idIndex334 = 0; idIndex334 < idListLen334; idIndex334++) {
        var idData334 = idList334[idIndex334];
        ie_open('tr', null, null, 'data-row', idIndex334);
        ie_open('td');
        ie_open('span');
        itext((goog.asserts.assert(opt_data.destinations[opt_data.tactics[idData334].destinationId].name != null), opt_data.destinations[opt_data.tactics[idData334].destinationId].name));
        ie_close('span');
        ie_close('td');
        ie_open('td');
        ie_open('span');
        itext((goog.asserts.assert(opt_data.tactics[idData334].name != null), opt_data.tactics[idData334].name));
        ie_close('span');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData334].oneToOnePromos.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData334].oneToOnePromos.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData334].promotionalAds.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', 'glyphicon glyphicon-trash table-action-icon table-action-remove', 'data-onclick', 'remove_');
        ie_close('td');
  ...
  var TacticsTable = function (_Component) {
    babelHelpers.inherits(TacticsTable, _Component);

    function TacticsTable() {
      babelHelpers.classCallCheck(this, TacticsTable);
      return babelHelpers.possibleConstructorReturn(this, _Component.apply(this, arguments));
    }
  ...
  this.CM.TacticsTable = templates;
  this.CMNamed.TacticsTable = this.CMNamed.TacticsTable || {};
  this.CMNamed.TacticsTable.TacticsTable = TacticsTable;
  this.CMNamed.TacticsTable.templates = templates;
  /* jshint ignore:end */
}).call(this);
'use strict';
...
(function () {
	var dom = this.CM.dom;
	var templates = this.CM.TacticsTable;
	var Component = this.CM.component;
	var Soy = this.CM.Soy;
