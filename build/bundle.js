...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias2({ children: param176, key: 'card0', cssClass: 'clearfix' }, null, opt_ijData);
      ie_close('div');
      ...
      $templateAlias2({ children: param186, key: 'card1-0', cssClass: 'clearfix' }, null, opt_ijData);
      ie_close('div');
      ...
      $templateAlias2({ children: param196, key: 'card2', cssClass: 'clearfix' }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      $templateAlias3({ children: param281 }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
    }
    exports.render = $render;
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var campaignIndex318 = 0; campaignIndex318 < campaignListLen318; campaignIndex318++) {
        ...
        ie_open('tr', null, null, 'data-id', campaignData318.id);
        ie_open('td');
        ie_open('span');
        ...
        ie_close('td');
        ie_open('td');
        ie_open('a', null, null, 'href', opt_data.basePath + '/edit-campaign/' + campaignData318.id, 'data-onclick', 'edit_');
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var idIndex337 = 0; idIndex337 < idListLen337; idIndex337++) {
        ...
        ie_open('tr', null, null, 'data-row', idIndex337);
        ie_open('td');
        ie_open('span');
        ...
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData337].oneToOnePromos.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData337].oneToOnePromos.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData337].promotionalAds.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', 'glyphicon glyphicon-trash table-action-icon table-action-remove', 'data-onclick', 'remove_');
        ie_close('td');
