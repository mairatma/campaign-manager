...
(function () {
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      ie_open('a', null, null, 'href', opt_data.basePath + opt_data.sourceUrl, 'class', 'btn btn-lg btn-success', 'data-onclick', 'save');
      itext((goog.asserts.assert((opt_data.editCampaignId != null ? 'Save' : 'Create') != null), opt_data.editCampaignId != null ? 'Save' : 'Create'));
      itext(' Campaign');
      ie_close('a');
      ie_open('a', null, null, 'href', opt_data.basePath + opt_data.sourceUrl, 'class', 'btn btn-lg btn-lighter');
      itext('Cancel');
      ie_close('a');
      ie_close('div');
      ie_close('div');
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      var param278 = function param278() {
        ...
        ie_close('select');
        ie_close('div');
        $templateAlias4({ basePath: opt_data.basePath, campaigns: opt_data.filteredCampaigns ? opt_data.filteredCampaigns : [], currentUrl: opt_data.currentUrl }, null, opt_ijData);
      };
      $templateAlias3({ children: param278 }, null, opt_ijData);
      ie_close('div');
      ie_close('div');
    }
    exports.render = $render;
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var campaignIndex320 = 0; campaignIndex320 < campaignListLen320; campaignIndex320++) {
        ...
        ie_open('tr', null, null, 'data-id', campaignData320.id);
        ie_open('td');
        ie_open('span');
        ...
        ie_close('td');
        ie_open('td');
        ie_open('a', null, null, 'href', opt_data.basePath + '/edit-campaign/' + campaignData320.id, 'data-onclick', 'edit_');
  ...
  goog.loadModule(function (exports) {
    ...
    function $render(opt_data, opt_ignored, opt_ijData) {
      ...
      for (var idIndex339 = 0; idIndex339 < idListLen339; idIndex339++) {
        ...
        ie_open('tr', null, null, 'data-row', idIndex339);
        ie_open('td');
        ie_open('span');
        ...
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData339].oneToOnePromos.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData339].oneToOnePromos.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', opt_data.tactics[idData339].promotionalAds.length > 0 ? 'glyphicon glyphicon-ok' : '');
        ie_close('td');
        ie_open('td');
        ie_void('span', null, null, 'class', 'glyphicon glyphicon-trash table-action-icon table-action-remove', 'data-onclick', 'remove_');
        ie_close('td');
