    ...
    ie_open('div', null, null,
      ...
      ie_open('div', null, null,
        ...
        ie_open('div', null, null,
          ...
          $templateAlias2({children: param213, key: 'card0', cssClass: 'clearfix'}, null, opt_ijData);
        ie_close('div');
        ie_open('div', null, null,
          ...
          $templateAlias2({children: param223, key: 'card1-0', cssClass: 'clearfix'}, null, opt_ijData);
        ie_close('div');
        ie_open('div', null, null,
            'id', 'campaign-manager-leads-card',
            'class', 'col-md-4 campaign-manager-card-wrapper');
          var param233 = function() {
            ie_open('div', null, null,
                'class', 'col-md-5');
              ie_open('div', null, null,
                  'class', 'highlight big');
          ...
          $templateAlias2({children: param233, key: 'card2', cssClass: 'clearfix'}, null, opt_ijData);
        ie_close('div');
      ie_close('div');
      ie_open('div', null, null,
